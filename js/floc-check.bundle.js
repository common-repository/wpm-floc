...
/* WEBPACK VAR INJECTION */(function(jQuery, $) {var checkFloc = function checkFloc() {
  ...
  jQuery.get(wpApiSettings.root + 'wpmfloc/v1/check-flock?_wpnonce=' + wpApiSettings.nonce, function (data) {
...
jQuery(document).ready(function ($) {
  $('.js--check-floc').on('click', function () {
    checkFloc();
  });
});
